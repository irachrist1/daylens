...
the blocks and the apps and the sites that were used during that day. The recap uses the
shared Daylens voice from `ai.md` §3: warm, plain language, short sentences, and enough
detail to understand the day without reading like a dashboard.
