...
- Proactive briefs, new Wrapped work, and the frozen current web surfaces: dispositions recorded in [V2 direction](product/v2.md#existing-features-during-the-transition).
