-- Daylens database schema as it shipped at schema_version 25 (app v1.0.36,
-- the first open-source baseline). This file is a frozen artifact for the
-- upgraded-database migration fixture: tests boot it, seed a representative
-- day at this shape, and run every later production migration against it.
-- Never edit it to match the current schema — migrations must upgrade it.
