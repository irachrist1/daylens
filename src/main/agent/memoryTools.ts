...
export function buildMemoryTools(deps: MemoryToolDeps) {
  return {
    propose_memory: tool({
      description: 'Offer to remember ONE durable personal or work fact the user just told you about themselves ("I lead the pricing project", "Fridays are focus days"). The user sees the exact statement and confirms, edits, or declines — nothing is saved without their confirmation, so never claim to remember anything unless this tool returned saved: true. Use it sparingly: only for clearly durable facts the user stated about themselves or their work, never for questions, transient states, or anything you inferred. NEVER propose secrets, credentials, health, or financial details. Do not re-propose a fact this tool reported as declined or already saved.',
